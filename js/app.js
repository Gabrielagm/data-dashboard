window.addEventListener('load', function(event){
      ...
      optgroupt.addEventListener('change', function(event){
          ...
          generation.addEventListener('change', function(event){   
              ...
              var selectedSede = Object.keys(data[sede]);
              ...
              for (var s in datesGen.ratings){
                var dataStudent = {};
                dataStudent = datesGen.ratings[s]; //{sprint: 2, nps: {…}, student: {…}, teacher: 4.1, jedi: 4.2}
                var dataExpectation = dataStudent.student;  //{no-cumple: 6, cumple: 75, supera: 19}
              }
            
              for (var nc in dataExpectation){
                var noCumple = {};
                noCumple = Object.keys(dataExpectation)[0];
              }
              console.log(noCumple); //no-cumple
              console.log(dataAlumns);
              console.log(dataSede); //{2016-2: {…}, 2017-1: {…}} --> value de cada sede
              console.log(dataStudent); //{sprint: 2, nps: {…}, student: {…}, teacher: 4.1, jedi: 4.2}
              console.log(dataExpectation); //no-cumple: 6, cumple: 75, supera: 19}
            console.log(datesGen); //{students: Array(46), ratings: Array(2)}
            console.log(datesGen.ratings[1].student); //{sprint: 2, nps: {…}, student: {…}, teacher: 4.1, jedi: 4.2}
            console.log(datesGen.ratings[1].student["cumple"]);
            console.log(datesGen.ratings[1].student["supera"]);
            console.log(Object.keys(dataSede)[0]);//(2) ["2017-1", "2017-2"]
            console.log(Object.keys(dataSede));
